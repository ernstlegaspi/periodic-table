...
export default function Column13() {
	return <div className='absolute ml-[1224px]'>
		<Element color='metalloid metalloid-text-shadow' mass='10.81' name='Boron' number='5' symbol='B' top='mt-[102px]' />
		<Element color='post-metal post-metal-text-shadow' mass='20.982' name='Aluminum' number='13' symbol='Al' top='mt-[204px]' />
