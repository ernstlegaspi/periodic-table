...
export default function Column3() {
	return <div className='absolute ml-[204px]'>
		...
		<Element notHoverable color='lanthanoid lanthanoid-text-shadow' mass='' name='' number='' symbol='57-71' top='mt-[510px]' />
		<Element notHoverable color='aktinoid aktinoid-text-shadow' mass='' name='' number='' symbol='89-103' top='mt-[612px]' />
